  ...
  return (
    <svg viewBox="0 0 330 290" focusable="false">
      <g className={styles.handwriting} fill="currentColor">
        ...
        <text x="53" y="102" className={styles.inkGreen} style={{ fontSize: '20px' }}>+</text>
        <text x="92" y="102" style={{ fontSize: '20px' }}>more curiosity</text>
        <text x="53" y="150" className={styles.inkGreen} style={{ fontSize: '20px' }}>+</text>
        <text x="92" y="150" style={{ fontSize: '20px' }}>better questions</text>
        <text x="53" y="198" className={styles.inkAmber} style={{ fontSize: '20px' }}>−</text>
        <text x="92" y="198" style={{ fontSize: '20px' }}>unnecessary complexity</text>
        <text x="51" y="246" className={styles.inkMuted} style={{ fontSize: '20px' }}>~</text>
